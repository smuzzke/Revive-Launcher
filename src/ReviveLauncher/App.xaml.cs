...
namespace ReviveLauncher
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            ReviveRPC.Start();
            bool createdNew;
            Mutex mutex = new Mutex(true, "PROJECTREVIVELAUNCHER", out createdNew);
            ...
            {
                MessageBox.Show("Revive Launcher is already running. Please close it before opening a new instance.", "Already Running");
                Environment.Exit(1);
            }
        }
