    ...
    private void MainNavigation_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
        {
            ...
            /*
             *  <NavigationViewItem x:Name="AdminPanelItem" Content="Admin Panel">
                    <NavigationViewItem.Icon>
                        <FontIcon Glyph="&#xE88A;"/>
                    </NavigationViewItem.Icon>
                </NavigationViewItem>

            if (Definitions.UserName == "Antonio" ||  Definitions.UserName == "Rio")
            {
            if ((args.SelectedItem as NavigationViewItem) == AdminPanelItem)
            {
                NavigationService.Navigate(typeof(AdminPanel), null, true);
            }
            }
            */
