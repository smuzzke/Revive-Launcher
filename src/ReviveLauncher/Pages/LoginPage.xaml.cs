...
using ReviveLauncher.Core;
using ReviveLauncher.Interop;
using ReviveLauncher.MongoDB;
    ...
    public sealed partial class LoginPage : Page
    {
        ...
        public void UserBanned()
        {
            try // it crashes so lets put it in a try ig
            {
                ...
                TextBlock desc = new TextBlock();
                desc.Text = "Your account has been banned appeal at discord.gg/revivefn";
        ...
        public void ConnectionFailure()
        {
            ...
            TextBlock desc = new TextBlock();
            desc.Text = "Revive API is not responding please try again later.";
        ...
        async Task ShowUselessMessagesTask()
        {
            //changed mind about this, he asked me to revert this, but will keep them in here if he changes his mind again
            return;

            //rio asked me to put this in, it is really useless and a big waste of time (the only thing that might be usefull is the updates thing)
            //removing it would make it be much faster, idk why slow it down
            //i cant believe i have to make this


            UselessStatusBlock.Text = "Contacting Revive Services...";
            await Task.Delay(1500);
            UselessStatusBlock.Text = "Checking for Updates...";
            //maybe check for updates here
            await Task.Delay(1500);
            UselessStatusBlock.Text = "Loading Content Assets..."; //what is this supposed to even do??
            await Task.Delay(1500);
            UselessStatusBlock.Text = "Logging In...";// that is the only thing we actually do on this page lol
            await Task.Delay(1500);
            UselessStatusBlock.Text = "";
        }
    }
}
