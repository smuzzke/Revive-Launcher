...
namespace ReviveLauncher.Pages
{
    ...
    public sealed partial class PlayPage : Page
    {
        ...
        */
            ...
            if (Definitions.BindPlayButton)
            {
                if (!Definitions.ConnectionFailedToAPI)
                {
                    ...
                    if (MainLaunchCard.Tag.ToString().Contains("Launch"))
                    {
                        ...
                        else
                        {
                            ...
                            if (basefn != null)
                            {
                                ...
                                {
                                    string CheckFiles = await FortniteFiles.CheckForMods(basefn);
                                    bool VerifyClient = await FortniteFiles.VerifyClient(basefn);
                                    try
                                    {
                    ...
                    else
                    {
                        ...
                        MainLaunchCard.Header = "Launch Season 8";
                        MainLaunchCard.Description = "Launch Fortnite Chapter 1 Season 8 powered by Revive";
        ...
        {
            var uri = "https://revivefn.sellix.io/";
        ...
        {
            var uri = "https://discord.gg/revivefn";
            var psi = new System.Diagnostics.ProcessStartInfo();
            psi.UseShellExecute = true;
            psi.FileName = uri;
            System.Diagnostics.Process.Start(psi);
